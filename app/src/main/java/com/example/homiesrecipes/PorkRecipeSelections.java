...
public class PorkRecipeSelections extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        porkRecipeDataArrayList.add(new PorkRecipeData("Pork Adobo with Tokwa and Tausi",
                ...
                "1. Prepare the toasted garlic by heating oil in a pan. Add crushed garlic while oil is heating up. Cook in low heat until garlic turns golden brown. Set aside. Note: the oil used to cook the garlic turns to garlic oil. \n" +
                        "\n" + "2. Heat half of the garlic oil in a pan. Sauté pork until light brown. \n" + "\n" + "3. Pour soy sauce and vinegar. Let boil. \n" + "\n" + "4. Add salted black beans and water. Cover and cook for 40 minutes or until pork gets tender. \n" +
                        "\n" + "5. Add fried tofu and sugar. Stir and cook for 3 minutes. Transfer to a serving plate. \n" + "\n" + "6. Prepare the fried rice by combining salt and rice. Mix gently. \n" +
                        "\n" + "7. Heat the remaining toasted garlic and oil in a pan. Add rice. Pour-in adobo sauce. Stir-fry for 3 to 5 minutes. \n" + "\n" + "8. Serve with pork adobo. Enjoy! ", R.drawable.porkadobo));
        porkRecipeDataArrayList.add(new PorkRecipeData("Pork Humba with Tokwa",
                ...
                "1. Heat cooking oil in a wok or cooking pot. Add tofu. Deep fry until outer part turns golden brown and crisp. Remove from the wok. Set aside. \n" + "\n" +
                        "2. Transfer 3 tablespoons cooking oil used to fry tofu on a clean pan. Heat and sauté garlic until it starts to brown. Add onion. Continue sauteing until the later softens. \n" +
                        "\n" + "3. Add pork. Cook until the outer part turns light brown. \n" + "\n" + "4. Pour soy sauce. Continue sauteing until liquid reduces to half. \n" + "\n" + "5. Add pineapple juice and vinegar. Cover and let boil. \n" +
                        "\n" + "6. Stir and then add salted black beans. Cover once more. Continue cooking between low to medium heat for 35 minutes. \n" + "\n" + "7. Add water and brown sugar. Cook on a covered pan until pork gets very tender. Note: I usually cook it for 40 minutes in low heat. \n" + "\n" +
                        "8. Add star anise. Cook for 5 minutes. Remove star anise from the wok. \n" + "\n" + "9. Season with ground black pepper and then add fried tofu. Stir and cook for 2 minutes. \n" +
                        "\n" + "10. Transfer to a serving bowl. Serve. \n" + "\n" + "11. Share and enjoy! ", R.drawable.porkhumba));
        porkRecipeDataArrayList.add(new PorkRecipeData("Tokwat Baboy",
                ...
                "1. Pour-in water in a pot and bring to a boil \n" + "\n" + "2. Add salt and whole peppercorn \n" + "\n" + "3. Put-in the pig's ears and pork belly then simmer until tender (about 30 mins to 1 hour) \n" +
                        "\n" + "4. Pour cooking oil on a separate pan and allow to heat \n" + "\n" + "5. When the oil is hot enough, deep-fry the tofu until color turns golden brown and outer texture is crispy \n" + "\n" +
                        "6. Cube the fried tofu and slice the boiled pig's ears and pork belly into bite-sized pieces then set aside \n" + "\n" + "7. Combine the sugar, salt, soy sauce, and vinegar in bowl. Stir. \n" + "\n" +
                        "8. Microwave for 1 minute. \n" + "\n" + "9. Add the ground black pepper, onions, green onions, and chili pepper. Transfer the sauce in a serving bowl. \n" + "\n" +
                        "10. Place the sliced meat and tofu in a serving plate with the bowl of sauce by the side \n" + "\n" + "11. Serve hot! Share and enjoy! ", R.drawable.tokwataboy));
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String s) {
                porkRecipeAdapter.getFilter().filter(s.toLowerCase().toString());
                return false;
            }
