...
public class PorkRecipeData {
    String recipeName, recipeDescription, recipeIngredients, recipeInstructions;
    Integer recipeImageURL;

    public PorkRecipeData(String recipeName, String recipeDescription, String recipeIngredients, String recipeInstructions, Integer recipeImageURL) {
