...
public class BeefRecipeData {
    String recipeName, recipeDescription, recipeIngredients, recipeInstructions;
    Integer recipeImageURL;

    public BeefRecipeData(String recipeName, String recipeDescription, String recipeIngredients, String recipeInstructions, Integer recipeImageURL) {
